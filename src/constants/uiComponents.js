...
export const COMMISSION = [
  {
    name: 'Commission - Set-up Elements',
    menuName: 'Set-up Elements',
    desc: 'Commission - Set-up Elements - Description',
...
const UIHOVER = [
  {
    ...
    menuName: 'Basic',
    desc:
      'A mouse hover, also called just hover, triggers an event when a user places a mouse over a designated area',
...
const UIMORE = [
  ...
  },
  {
    name: 'Callout',
    desc:
      'A callout is often a short piece of text set in larger type or with colorful background and intended to attract attention.',
  ...
  },
  {
    name: 'Ribbon',
    desc:
      'A ribbon is used primarily as decorative binding for highlighting a piece of information.',
...
const UINAVIGATION = [
  ...
  },
  {
    name: 'Dropdown',
    desc:
      'A dropdown list. If there are too many operations to display, you can wrap them in a Dropdown.',
    path: '/app/ui/navigation/dropdown',
  },
  {
    name: 'Pagination',
    desc:
      'When it will take a long time to load/render all items. Or if you want to browse the data by navigating through pages.',
...
const UIUTILITY = [
  {
    name: 'Overlay',
    desc:
      "Overlays are often used when you want to make the content on top of an image more readable. It's used on components like Image Cards, Covers, Hero etc.",
...
export const UIKIT = [
  ...
  },
  {
    name: 'Sash',
    desc:
      'A sash is a large and usually colorful ribbon or band of material positioned around the content body',
    path: '/app/ui/sash',
  },
  {
    name: 'Tabs',
  ...
  },
  {
    name: 'Testimonial',
    desc:
      "A testimonial consists of a person's written or spoken statement extolling the virtue of a product.",
...
const FORMCONTROLS = [
  ...
  },
  {
    name: 'Switch',
    desc:
      'Switching Selector. Usage: If you need to represent the switching between two states or on-off state.',
  ...
  },
  {
    name: 'AutoComplete',
    desc:
      'Autocomplete function of input field. Usage: When there is a need for autocomplete functionality.',
...
export const FORMS = [
  ...
  },
  {
    ...
    desc:
      "Validate status and/or message will be displayed when user's input violate specified validation rules",
...
export const FEEDBACKS = [
  {
    name: 'Modal / Dialog',
    desc:
      "Modal dialogs. Usage: When requiring users to interact with the application, but without jumping to a new page and interrupting the user's workflow",
...
export const TABELS = [
  ...
  },
  {
    ...
    menuName: 'Data Table',
    desc:
      'Usage: to display a collection of structured data and to sort, search, paginate, filter data.',
