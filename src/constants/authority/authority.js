...
export const USER_AUTHORITY_SECTION = {
  ...
  SECTION04: 'REPORT',
  SECTION05: 'ACCOUNT',
  SECTION06: 'PAYEE_SERVICE',
  SECTION07: 'IPG_SERVICE',
  SECTION08: 'COMMISSION',
};
...
export const USER_AUTHORITY_CODE = {
  ...
  POS_DEVICE_VERSION_MANAGEMENT: 'PDVM-D',
  POS_DEVICE_PACKAGE_MANAGEMENT: 'PDVM-D',
  ...
  REPORT_CARDS: 'RC-D',
  REPORT_COREBANK: 'RCB-D',
  REPORT_COREBANK_2: 'RCB2-D',
  REPORT_SCHEDULE: 'RS-D',
  REPORT_AGENT_CURRENT_BALANCE: 'RACB-D',
  ...
  // PAYEE SERVICES
  SALARY_UPLOAD: 'PSSU-D',

  //IPG SERVICES
  IPG_SERVICE_MANAGEMENT: 'IPGSM-D',

  //COMMISSION
  COMMISSION_SETUP_ELEMENTS: 'COMMSE-D',
  COMMISSION_SETUP_COMMISSION: 'COMMSC-D',
  //COMMISSION_SETUP_COMMISSION: 'NOTSHOW-D',
};
...
const USER_AUTHORITY = {
  DISPLAY_AUTHORITIES: {
    ...
    [USER_AUTHORITY_SECTION.SECTION02]: [
      ...
      USER_AUTHORITY_CODE.POS_DEVICE_VERSION_MANAGEMENT,
    ],
    ...
    [USER_AUTHORITY_SECTION.SECTION04]: [
      ...
      USER_AUTHORITY_CODE.REPORT_COREBANK,
      USER_AUTHORITY_CODE.REPORT_COREBANK_2,
      USER_AUTHORITY_CODE.REPORT_SCHEDULE,
      USER_AUTHORITY_CODE.REPORT_AGENT_CURRENT_BALANCE,
    ],
    [USER_AUTHORITY_SECTION.SECTION05]: [
      USER_AUTHORITY_CODE.ACCOUNT_UPLOAD,
      USER_AUTHORITY_CODE.ACCOUNT_MANAGEMENT,
    ],
    [USER_AUTHORITY_SECTION.SECTION06]: [USER_AUTHORITY_CODE.SALARY_UPLOAD],
    [USER_AUTHORITY_SECTION.SECTION07]: [USER_AUTHORITY_CODE.IPG_SERVICE_MANAGEMENT],
    [USER_AUTHORITY_SECTION.SECTION08]: [
      USER_AUTHORITY_CODE.COMMISSION_SETUP_ELEMENTS,
      USER_AUTHORITY_CODE.COMMISSION_SETUP_COMMISSION,
    ],
  },
